...
func run() (err error) {
	...
	// Postgres
	// TODO: in the future add condition to check coordinator or agent
	...
	workers := workers.NewWorkers(telemetryWorker, providersMasterWorker, cleanerWorker, logger, config.Role, config.CoordinatorURL)
	go func() {
